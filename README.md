...
This version of PoseMod was edited to instead of launch a specific instance, it will run the game through steam and inject the mod that way. In my mind, it's similar to the way Unverum or tModLauncher works.
